...
> Compagnon de [06-business.md](06-business.md). Cette fiche part d'un rapport déjà généré par un des starters `generateur-audit-ia-*` (voir `livrables/chatllow/`) et explique comment passer de ce rapport à une mission réellement vendue et livrée. Scénario fil conducteur : le starter BTP, avec un client fictif "Bâtir Conseil SARL".
