...
- ~~Relation avec le portail existant~~ : tranché le 2026-09-13. `livrables/vivier-ia/2026-09_portail-academie/` est **absorbé** par Vivier Academies plutôt que maintenu séparément : la nouvelle plateforme devient elle-même la vitrine publique, pour les deux espaces. Le portail existant sera à archiver ou rediriger une fois la vitrine construite (étape 3).
...
- Modules 1 (Écosystème Claude, 7 sections), 3, 4 et 5 rédigés intégralement (contenu texte source dans `livrables/vivier-ia/cours/ecosysteme-ia/`) ; Module 2 (n8n) a son guide de réussite mais pas encore ses sections en base
...
- Vitrine Chatllow légère au sein de Vivier Academies (à ne pas confondre avec la plateforme Chatllow autonome, un projet distinct — voir `livrables/chatllow/2026-09_plateforme-chatllow/`)
