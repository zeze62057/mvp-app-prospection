# Enregistrement et mise en ligne : Comment bien suivre la formation

Section 0, chapitre 2. Voir `01-script.md` et `02-diapositives.md`.
...
- Tester le diaporama en mode présentation, avec les clics : `diapositives-chapitre-2.pptx`, 10 clics en tout.
...
**Titre** : Comment bien suivre la formation

**Description** : Une vidéo sans pratique ne construit rien de durable. Découvrez la méthode qui fonctionne, le principe du signal de passage, et comment utiliser la communauté.
...
- La communauté sert à débloquer une vraie difficulté, pas seulement à être consultée.

**Durée** : à renseigner après l'enregistrement (estimation : 2 min 22 s avant montage).
