...
Pour une campagne de conseil, tester deux objets différents ("Votre transformation IA en 2026" contre une question directe "Où en est votre entreprise sur l'IA ?") sur deux moitiés de la même liste de prospects révèle objectivement lequel accroche le mieux ce public précis.
...
Pour un cabinet de conseil, un scénario avancé pourrait envoyer un email initial, puis si le prospect l'a ouvert sans répondre, enchaîner sur une demande de connexion LinkedIn personnalisée quelques jours après, plutôt que de répéter simplement un email de relance identique.
...
5. Imagine un scénario à 2 canaux (email + un autre) pour une campagne de ton activité, avec au moins une branche conditionnelle selon le comportement du prospect.
