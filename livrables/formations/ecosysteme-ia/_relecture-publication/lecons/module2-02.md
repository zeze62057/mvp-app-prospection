...
1. Crée un nouveau workflow séparé, dédié aux erreurs (par exemple "Alertes erreurs").
...
Cette mise en situation combine plusieurs chapitres de la section pour un cas concret et directement transposable à un cabinet de conseil : un formulaire de contact envoie une demande, et le workflow doit qualifier, router, et notifier sans intervention manuelle systématique.
...
### Réflexion
6. Reprends le workflow de qualification commerciale de l'atelier : propose un critère de qualification adapté à une demande reçue par un cabinet de conseil, différent de ceux donnés en exemple.
