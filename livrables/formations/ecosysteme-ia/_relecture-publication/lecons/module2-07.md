...
Après quelques mois d'activité, une instance n8n peut compter des workflows pour plusieurs clients différents. Un dossier par client, avec un tag "actif" ou "archivé", permet de retrouver en quelques secondes le bon workflow, plutôt que de faire défiler une liste de cinquante noms génériques sans distinction.
...
Une revue trimestrielle de l'instance révèle une credential Gmail créée pour un client dont la mission s'est terminée quatre mois plus tôt, toujours active. La désactiver referme un accès qui n'avait plus aucune raison de rester ouvert.
...
4. En repensant à l'ensemble du Module 2, quel chapitre te semble le plus directement applicable à ton activité actuelle ? Pourquoi ?
