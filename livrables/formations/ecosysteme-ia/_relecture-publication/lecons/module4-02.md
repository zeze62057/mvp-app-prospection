...
Pour le récapitulatif hebdomadaire (Module 2, section 6), la liste des distributeurs et leurs coordonnées relève du niveau "interne" : elle circule dans l'organisation mais ne devrait jamais être publiée ou partagée hors de ce cadre sans consentement explicite.
...
### Réflexion
5. Cartographie rapidement un flux de données réel de ton activité : d'où vient la donnée, où va-t-elle, qui y a accès, quel niveau de classification lui donnerais-tu ?
