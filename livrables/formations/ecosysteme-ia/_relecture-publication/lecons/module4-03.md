...
Pour un audit chez un client CAC40, intégrer un point de conformité dans le brief initial (chapitre 2 de la section 7 du Module 3) évite qu'un service juridique interne bloque le projet en cours de route, après que l'essentiel de la construction ait déjà été fait.
