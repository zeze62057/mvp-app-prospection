...
- Q1 : une boîte email neuve sans warm-up se fait très souvent classer en spam dès un envoi massif, même avec un excellent message
- Q2 : Campaigns, People Database, Sequences, Tracking
- Q3 : que l'envoi est légitime et non usurpé, aux yeux des fournisseurs de messagerie
- Q4 : la part des messages qui arrivent réellement en boîte de réception ; une baisse pendant une campagne est un signal à traiter immédiatement, pas à ignorer
- Q5 : sa boîte email risque d'être classée en spam rapidement, ce qui compromet la délivrabilité de toutes ses campagnes futures, pas seulement celle-ci
