...
| `parametres.html` / `parametres.js` | Paramètres agent : comptes réseaux sociaux, message de premier contact, et personnalisation de la page publique (textes + photo/vidéo par upload ou lien) |
