...
// Conversation d'exemple, montree seulement tant que le fil du client est vide. Etiquetee "Exemple" :
// ce n'est pas un echange reel.
const EXEMPLE_QUESTION =
...
const EXEMPLE_INTRO =
  "Excellente initiative ! L'IA peut effectivement **transformer** votre service client en améliorant la réactivité, la qualité des réponses et la satisfaction de vos clients. Voici les étapes clés pour démarrer :";
const EXEMPLE_ETAPES = [
        ...
        {messages.length === 0 && (
          <>
            <p className="rounded-lg bg-[var(--indigo-soft)] px-3.5 py-2 text-center text-[12px] font-semibold text-[oklch(45%_0.19_250)]">
              ...
              {disponible
                ? "Votre échange remplacera cet exemple dès votre premier message."
                : "L'assistant est en cours de configuration : il sera disponible très prochainement."}
            </p>
            <div className="flex items-start justify-end gap-3">
              <div className="max-w-[78%]">
                <div className="rounded-2xl rounded-tr-md bg-[var(--indigo-soft)] px-4 py-3 text-[13.5px] leading-relaxed">{EXEMPLE_QUESTION}</div>
              </div>
