...
- **Le générateur d'audit interne existant** (`livrables/applications/2026-09_generateur-audit-ia-chatllow/`) reste un outil séparé, rempli par Zézé après un RDV déjà obtenu. Ne pas le fusionner avec le diagnostic public sans décision explicite.
- **Distinction avec Vivier Academies** : la future page de présentation Chatllow mentionnée dans le cadrage de Vivier Academies (`livrables/applications/2026-09_plateforme-formation-communaute/CADRAGE.md`) est un objet plus léger, pour une audience déjà captive. Ne pas la confondre avec cette plateforme autonome.
...
**Tranchée le 2026-09-16.** Piste "Signal net" retenue parmi 5 explorées (voir `livrables/identites-visuelles/2026-09_chatllow-identite-visuelle/`, canvas Claude Design — les 4 pistes non retenues restent sur la page "Explorations", ne pas les supprimer).
