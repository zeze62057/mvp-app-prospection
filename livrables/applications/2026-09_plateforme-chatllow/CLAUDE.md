...
**Tranchée le 2026-09-16.** Piste "Signal net" retenue parmi 5 explorées (voir `livrables/cabinet/2026-09_chatllow-identite-visuelle/`, canvas Claude Design — les 4 pistes non retenues restent sur la page "Explorations", ne pas les supprimer).
