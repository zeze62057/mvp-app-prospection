...
- **Vivier IA** : conception de l'école de l'IA sur l'écosystème Claude (anciennement "Entrepreneur Académie"). Plateforme Vivier Academies (espaces Vivier IA et Bâtisseur Pro), modules de cours 1 à 5 rédigés. Le 19 septembre 2026 : 50 leçons du programme marketing de réseau chargées dans Bâtisseur Pro, indicateurs et réglages de communauté ajoutés à l'admin. Restent les modules 2 à 5 de Vivier IA à charger en base et les vidéos à enregistrer. Dossier : `livrables/applications/2026-09_plateforme-formation-communaute/` (plateforme) et `livrables/formations/` (cours)
